...
public class SyntaxChecker {
   ...
   */
	public boolean checkExpression(String exp) {
      ...
      for( char c : exp.toCharArray()){ //for int i ... //exp .charAt(i)
         //get every charater in the string ...
         String symbol = c + ""; //bcoz map has strings
         if(SYNTAX.keySet().contains(symbol)){
            ...
            String popped = stack.pop(); //opening symbol poped off..
